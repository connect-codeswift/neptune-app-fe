        ...
        return (
          <button
            ...
            onClick={() => {
              ...
              className={[
                "text4 inline-flex shrink-0 cursor-pointer items-center gap-1.5 border-b-[1.5px] px-[18px] pt-2.5 pb-[11px] whitespace-nowrap transition-colors",
                isActive
            ...
            >
              ...
              {showCount ? (
                <span
                  className={[
                    "text8 rounded-[10px] px-[7px] py-px font-semibold",
                    isActive
