...
function DetailField(props: Readonly<{ label: string; children: ReactNode }>) {
  ...
  return (
    <div className="flex min-w-0 flex-col gap-1">
      <Text as="p" className="text-xs leading-4 text-[#8892a3]">
        {label}
      </Text>
        ...
        <div className="grid min-w-0 items-start gap-5 lg:grid-cols-[minmax(0,2.0fr)_minmax(240px,1fr)] lg:items-center lg:gap-7">
          <div className="flex min-w-0 flex-col gap-5">
              ...
              <div className="relative z-1 flex flex-col gap-4 p-4 sm:p-[20.2px]">
                <div className="flex min-w-0 items-center gap-3 sm:gap-4">
                  ...
                  <div className="flex min-w-0 flex-col">
                    <Text
                      as="p"
                      className="truncate text-3.75 leading-6 font-semibold text-[#0b1320] sm:text-base"
                    >
                      {document.title}
                    </Text>
                    <Text
                      as="p"
                      className="sm:text-3.5 truncate text-3.25 leading-5 text-[#566072]"
                    >
            ...
            >
              <Text
                as="h2"
                className="relative z-1 text-base leading-7 font-semibold text-[#0b1320] sm:text-lg sm:leading-6.75"
              >
                Document Details
              </Text>
              <div className="relative z-1 grid grid-cols-1 gap-4 min-[400px]:grid-cols-2">
                ...
                <DetailField label="Status">
                  <span className="inline-flex h-[21.7px] items-center gap-1.25 rounded-full bg-[rgba(11,19,32,0.14)] px-2.5">
                    <span
                      className="size-1.5 shrink-0 rounded-0.75 bg-[#566072]"
                      aria-hidden="true"
                    />
                    <Text
                      as="span"
                      className="text-2.75 leading-[15.7px] font-semibold tracking-[0.11px] text-[#566072]"
                    >
                      {displayStatus}
                    </Text>
                  </span>
          ...
          <div className="flex min-w-0 flex-col lg:self-start">
            <article className={`${detailCardClass} w-full min-w-0`}>
              <div className="relative z-1 flex flex-col gap-3 p-4 sm:gap-0 sm:px-5 sm:pt-5 sm:pb-5">
                <Text
                  as="h2"
                  className="text-base leading-7 font-semibold text-[#0b1320] sm:text-lg sm:leading-6.75"
                >
                ...
                <div className="flex flex-col items-stretch sm:mt-3">
                  <Text
                    as="p"
                    className="text-center text-6.5 leading-9 font-bold text-[#0b1320] sm:text-3xl"
                  >
                    {`${String(ackPercent)}%`}
                  </Text>
                  <Text
                    as="p"
                    className="text-center text-xs leading-4 text-[#566072]"
                  >
                ...
                <div className="mt-7 flex justify-center">
                  <Button
                    ...
                    variant="tertiary"
                    onClick={onApprovals}
                    className="text-3.5 h-9 w-45.75 max-w-full rounded-2 border border-[rgba(11,19,32,0.14)] px-2 leading-5 font-normal text-[#0b1320] shadow-none hover:bg-white/80"
                  >
                    Approvals
                  </Button>
                </div>
