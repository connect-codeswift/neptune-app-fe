...
export function AcknowledgeCommentsCard(
  ...
  return (
    <div
      className={["flex w-full min-w-0 flex-col gap-[18px]", className]
        .filter(Boolean)
        .join(" ")}
    >
      <Text
      ...
      <div className={glassCardClass}>
        <textarea
          ...
          rows={8}
          className="relative z-1 min-h-[199px] w-full resize-y bg-transparent px-4 py-[17px] text-[12px] leading-[18px] text-[#0b1320] outline-none placeholder:text-[#8892a3] sm:px-4"
        />
      </div>
    </div>
  );
