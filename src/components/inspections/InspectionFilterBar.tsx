...
import { REGISTER_STATUS_FILTERS } from "@/lib/audit-inspection-status";

export type InspectionFilterBarProps = Readonly<{
  status: string;
...
export function InspectionFilterBar(props: InspectionFilterBarProps) {
  const { status, onStatusChange, onTemplatesClick, className = "" } = props;
