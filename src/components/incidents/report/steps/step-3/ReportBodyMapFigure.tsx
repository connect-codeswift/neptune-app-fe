...
export function ReportBodyMapFigure(props: Readonly<ReportBodyMapFigureProps>) {
  ...
  return (
    <div
      className={[
        "rounded-3 mx-auto flex w-full max-w-65 flex-col items-center gap-1 self-start border border-[rgba(15,23,42,0.08)] bg-white/82 px-1.5 pt-2 pb-3 sm:gap-1.5 sm:px-3 sm:pt-2.5",
        className,
      ]
        .filter(Boolean)
        .join(" ")}
