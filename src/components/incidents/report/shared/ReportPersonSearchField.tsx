      ...
      <div className="relative">
        <input
          ...
          onChange={(event) => {
            ...
            setQuery(text);
            setOpen(true);
            // Typing over a picked name breaks the link to that account — the
            // id must not survive the text it stood for, and neither may a
            // gender that was read off it.
            onChange({ name: text, userId: "", gender: "" });
          }}
          onFocus={() => setOpen(true)}
          onKeyDown={onKeyDown}
          className={[FIELD_INPUT_CLASS, hasSelection ? "pr-16" : "pr-9"].join(
            " ",
          )}
        />
          ...
          {hasSelection ? (
            <>
              ...
              <button
                type="button"
                onClick={clear}
                aria-label="Clear affected person"
            ...
            >
              {siteId <= 0 ? (
                <li className="text-ehs-muted-text px-2.5 py-3 text-[13px]">
                  ...
                  roster to search. Type the person&apos;s name instead.
                </li>
                ...
                <li className="text-ehs-muted-text px-2.5 py-3 text-[13px]">
                  Couldn&apos;t load people for this site. Type the name
