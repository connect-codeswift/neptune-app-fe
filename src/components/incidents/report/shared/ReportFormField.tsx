...
export type ReportFieldHintProps = Readonly<{
  children: ReactNode;
 ...
 * neighbour.
 */
export function ReportFieldHint(props: Readonly<ReportFieldHintProps>) {
  const { children, withIcon = false } = props;

  // A plain <p>, like ReportFieldError: Text only accepts string children and
