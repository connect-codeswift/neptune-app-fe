  ...
  if (isLoading) {
    return (
      ...
      >
        ...
        <div className="h-9 animate-pulse rounded-[10px] bg-[rgba(15,23,42,0.06)]" />
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="bg-ehs-light-blue text-ehs-dark-blue inline-flex shrink-0 items-center gap-1 rounded-full px-2 py-px text-[10px] font-semibold">
