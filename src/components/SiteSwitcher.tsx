    ...
    <div ref={menuRef} className={["relative shrink-0", className].join(" ")}>
      ...
      >
        <Icon
          ...
          aria-hidden="true"
        />
        <span className="max-w-48 truncate whitespace-nowrap">{company}</span>
        {selectedSiteName === ALL_SITES ? null : (
          <span className="bg-ehs-light-blue text-ehs-dark-blue text-2.5 max-w-32 truncate rounded-full px-2 py-px font-semibold">
            {selectedSiteName}
          </span>
        )}
        <Icon
