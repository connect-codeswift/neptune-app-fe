    ...
    <div className="flex min-w-0 flex-col gap-5 px-4 pb-8">
      ...
      <div className="flex items-center justify-end gap-3">
        ...
        <button
          ...
          className="cursor-pointer rounded-[10px] bg-[#10b981] px-5 py-2.5 text-sm leading-5 font-medium text-[#eceef2] shadow-[0px_6px_18px_-6px_#10b981] transition-colors hover:bg-[#0ea572] disabled:cursor-not-allowed disabled:opacity-60"
        >
          {isAlreadyVerified
            ? "Already Verified"
