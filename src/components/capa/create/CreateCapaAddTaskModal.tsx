  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="flex w-full max-w-[420px] flex-col gap-5 rounded-2xl bg-white p-6 shadow-[0px_8px_24px_rgba(0,0,0,0.12)]"
      >
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="w-full rounded-lg border border-[#e2e8f0] bg-[#f8fafc] px-3.5 py-[11px] text-sm text-[#0b1320] outline-none placeholder:text-[#94a3b8] focus:border-[#0891a6] focus:ring-2 focus:ring-[#0891a6]/20"
            />
          </div>
