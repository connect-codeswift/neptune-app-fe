...
export function NearMissFilterBar(props: NearMissFilterBarProps) {
  ...
  return (
    <div className={[shellClass, className].filter(Boolean).join(" ")}>
      <span className="text-ehs-gray border-ehs-border border-ehs-border inline-flex shrink-0 items-center gap-1.5 rounded-xl border bg-white p-2.5 text-sm font-bold">
        <Icon
