    ...
    >
      ...
      {onRetry ? (
        <button
          type="button"
          onClick={onRetry}
          className="text8 border-ehs-border text-ehs-gray hover:bg-ehs-light-bg bg-ehs-surface mt-1 inline-flex cursor-pointer items-center gap-1 rounded-lg border px-3 py-1.5 font-medium transition-colors"
        >
