...
export type AuditChecklistHeaderProps = Readonly<{
  auditId: string;
  subtitle: string;
  onViewFindings?: () => void;
}>;

export function AuditChecklistHeader(props: AuditChecklistHeaderProps) {
  const { auditId, subtitle, onViewFindings } = props;
