      ...
      <div className="mt-3 flex flex-wrap items-center justify-between gap-3">
        {step === 1 ? (
          <button
            ...
            className="text4 text-ehs-dark-bg cursor-pointer rounded-2.5 border border-slate-900/12 bg-white px-5 py-2.5 transition-colors"
          >
            Cancel
          </button>
        ) : (
          <button
            ...
            className="text4 text-ehs-dark-bg inline-flex cursor-pointer items-center gap-2 rounded-2.5 border border-slate-900/12 bg-white px-5 py-2.5 transition-colors"
          >
            <Icon
              icon="mdi:arrow-left"
        ...
        {step < 5 ? (
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="text4 bg-ehs-normal-blue hover:bg-ehs-normal-blue-hover active:bg-ehs-normal-blue-active inline-flex cursor-pointer items-center gap-2 rounded-2.5 px-5 py-2.5 text-white shadow-[0px_6px_18px_-6px_#0891a6] transition-colors"
            >
              <Icon
