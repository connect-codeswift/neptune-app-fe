      ...
      <div className="flex min-w-0 flex-col gap-3.5">
        ...
        >
          ...
          <button
            ...
            className="text4 bg-ehs-normal-blue hover:bg-ehs-normal-blue-hover active:bg-ehs-normal-blue-active w-full cursor-pointer rounded-xl px-5 py-2.5 text-white shadow-[0px_6px_18px_-6px_#0891a6] transition-colors disabled:cursor-not-allowed disabled:opacity-60"
          >
          ...
          <button
            ...
            onClick={onSaveDraft}
            disabled={isSubmitting}
            className="text4 text-ehs-dark-bg -mt-1.5 w-full cursor-pointer rounded-xl border border-slate-900/12 bg-white px-5 py-2.5 transition-colors hover:bg-black/5 disabled:cursor-not-allowed disabled:opacity-60"
          >
            Save as Draft
          </button>
        </IncidentGlassCard>
