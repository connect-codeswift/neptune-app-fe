...
/**
 * Answer control an auditor can get for a checklist item. Free-text is the only
 * control offered — the old 12-option type picker (Number, Date/Time, Yes/No,
 * Signature, …) was removed, so every item is created and answered as text.
 */
...
/** Starting content, matching the design's seeded section. */
