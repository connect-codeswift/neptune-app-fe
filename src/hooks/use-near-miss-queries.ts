...
export function useNearMissRecognitionsQuery(
  params: Readonly<{ year: number; month: number }>,
) {
  return useQuery({
    queryKey: ["near-miss", "recognitions", params] as const,
    queryFn: () => getNearMissRecognitions(params),
