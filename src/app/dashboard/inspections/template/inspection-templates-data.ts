export type InspectionTemplate = Readonly<{
  id: string;
  title: string;
  sectionCount: number;
  itemCount: number;
...
export const INSPECTION_TEMPLATES: readonly InspectionTemplate[] = [
  {
    id: "iso-45001-annual",
  ...
  },
  {
    ...
    title: "Fire Safety Monthly Inspection",
    sectionCount: 4,
    itemCount: 24,
  ...
  },
  {
    ...
    title: "Chemical Management Inspection",
    sectionCount: 5,
    itemCount: 38,
  ...
  {
    id: "loto-checklist",
    title: "LOTO Inspection Checklist",
    sectionCount: 6,
    itemCount: 42,
    category: "Safety",
    scope: "Manufacturing",
  ...
  },
  {
    ...
    title: "Contractor Safety Inspection",
    sectionCount: 5,
    itemCount: 30,
    category: "Contractor",
    scope: "All",
